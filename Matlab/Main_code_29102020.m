...
ka    = 0.1;       % cost of adjustment (assuming the wage w is 1)
...
for n_ra = 1:N_ra
    ...
    updiag = [updiag; zeros(70,1)]; % at each break I*J (when r_a changes), need I zeros for zeta in order to generate the correct discretization.
end 
